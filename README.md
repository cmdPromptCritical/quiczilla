...
![Three stacked horizontal-bar charts comparing Quiczilla, SCP, and rsync throughput for three exact-1-GiB workloads: 16,384 64 KiB files, 102 10 MiB files plus a tail, and one 1 GiB file.](benchmarks/transfer-performance-v0.1.11.svg)
